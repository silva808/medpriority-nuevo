...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = mysqli_prepare($mysqli, "INSERT INTO usuario (id_usuario, nombre, edad, telefono, correo, genero, tipo_documento, direccion, id_rol, tipo_afiliacion) VALUES (?,?,?,?,?,?,?,?,?,?)");
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "Error adding new user: " . mysqli_error($mysqli);
    }
